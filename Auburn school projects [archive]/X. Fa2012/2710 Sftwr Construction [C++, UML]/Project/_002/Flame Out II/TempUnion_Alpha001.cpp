...
string verNum = "0A01.30Nov2012.19:39";
...
void commandline::parse_input_cmd(){
	...
	{
		is02 = input_command_to_parse.substr(space_last_found_at, space_found_at_next);

		is03 = input_command_to_parse.substr(space_found_at_next);
	}
...
void commandline::map_arg_three(string arg_in){
	...
	*/
	...
	else if (string::npos != arg_in.find(".")) //if a period is found at ANY poisition
		{
		//assume a file name
