   ...
   public class Review {
      ...
      private ArrayList<Integer> scores;
		private boolean hasSuperb = false;
      ...
      public String overallPerformance() {
			String performanceReturn = "";
      
         switch ((int) Math.round(calculateAverage())) {
            case POOR:
               performanceReturn = "Poor";
					break;
            case DECENT:
               performanceReturn = "Decent";
					break;
            case AVERAGE:
               performanceReturn = "Average";
					break;
            case GREAT:
               performanceReturn = "Great";
					break;
            case SUPERB:
               performanceReturn = "Superb";
					break;
            default:
               performanceReturn = "Unknown";
         }
			
			if (hasSuperb)
				{
				performanceReturn += " (has superb)";
				}
