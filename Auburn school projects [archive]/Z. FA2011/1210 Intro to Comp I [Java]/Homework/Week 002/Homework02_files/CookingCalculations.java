   ...
   public class CookingCalculations {
      ...
      public static void main(String[] args) {
         ...
         byte choice;
			int conversionAmount = 0, cups = 0, remaining = 0;
         ...
         conversionAmount = userIn.nextInt();
			...
			if (choice == 1) { //converting from tablespoons. 16 = 1 cup
				System.out.println("Converting from tablespoons....");
				cups = conversionAmount / 16;
				remaining = conversionAmount % 16;
				}
			else { //default. converting from teaspoons. 48 = 1 cup
				System.out.println("Converting from teaspoons....");
				cups = conversionAmount / 48;
				remaining = conversionAmount % 48;
				}
			
         System.out.print("The amount you entered is equal to " 
            + cups + " cups and " + remaining);
         if (choice == 1) {
            System.out.print(" tablespoons.");
         }
         else {
            System.out.print(" teaspoons.");
         }
      }
   }