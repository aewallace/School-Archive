...
class Participant: #76 lines #59 0n0e0w, 19 0m0o0d0i0f0i0e0d, 15 deleted, 139 0t0o0t0a0l0 CA03
    ...
    def __init__(self,name,mount = None,level = None,rating = None):
        ...
        self.storedXCScore = None #newCA06
    ...
    def setInternalXCScore(self, scoreIn): #newCA06
        scoreIn.level = self.level #newCA06
        self.storedXCScore = scoreIn #newCA06
        return True #newCA06
        
    def getXCScore(self): #newCA06
        return self.storedXCScore #newCA06
